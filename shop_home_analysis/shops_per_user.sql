...
select
  count(distinct case when unique_transactions = 1 then mapped_user_id end) as users_purchase_from_shop_1_time,
  count(distinct case when unique_transactions = 2 then mapped_user_id end) as users_purchase_from_shop_2_times,
  count(distinct case when unique_transactions = 3 then mapped_user_id end) as users_purchase_from_shop_3_times,
  count(distinct case when unique_transactions = 4 then mapped_user_id end) as users_purchase_from_shop_4_times,
  count(distinct case when unique_transactions = 5 then mapped_user_id end) as users_purchase_from_shop_5_times,  
  count(distinct case when unique_transactions = 10 then mapped_user_id end) as users_purchase_from_shop_10_times,
  count(distinct case when unique_transactions >= 15 then mapped_user_id end) as users_purchase_from_shop_15_more_times,
